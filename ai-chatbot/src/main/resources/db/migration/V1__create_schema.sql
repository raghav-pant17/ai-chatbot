...
CREATE TABLE customer_orders (
    ...
    CONSTRAINT fk_customer_orders_user
        FOREIGN KEY (user_id)
        REFERENCES ecommerce_users (user_id)
);

CREATE INDEX idx_customer_orders_user_time
    ON customer_orders (user_id, order_time DESC);
...
CREATE INDEX idx_tickets_order_status_updated
    ON tickets (user_id, order_id, status, updated_at DESC);
...
CREATE INDEX idx_chat_messages_ticket_timestamp
    ON chat_messages (ticket_id, timestamp);
